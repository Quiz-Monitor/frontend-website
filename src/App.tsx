...
import { StudentExamReviewPage } from "./components/StudentExamReviewPage";
...
/** Redirects /student/history/:examId → /student/exam-review/:examId */
function HistoryExamRedirect() {
	const { examId } = useParams<{ examId: string }>();
	return <Navigate to={`/student/exam-review/${examId}`} replace />;
}
				...
				<Router>
					...
					<Routes>
						...
						<Route
							...
							element={<ExamCreationWizardV2 />}
						/>
						<Route
							path="/instructor/results/:examId"
							element={<ResultsLogs />}
						/>
						<Route
							path="/instructor/results"
							element={<ResultsDatabasePage />}
						/>
						<Route
							path="/instructor/results-database"
							element={<ResultsDatabasePage />}
						/>
						<Route
							path="/instructor/exam-results/:examId"
							element={<ExamStudentsListPage />}
						/>
						{/* /instructor/student-result redirects consolidated into /instructor/review-exam */}
						<Route
							path="/instructor/review-exam/:examId/:studentId"
							element={<InstructorReviewExamPage />}
						/>
						<Route path="/student" element={<StudentDashboard />} />
						<Route path="/student/code-entry" element={<StudentCodeEntry />} />
						<Route
							path="/student/waiting/:examId"
							element={<StudentWaitingRoom />}
						/>
						<Route
							path="/student/permissions/:examId"
							element={<ExamPermissionsCheck />}
						/>
						<Route path="/student/exam/:examId" element={<ExamInterface />} />
						<Route path="/student/history" element={<StudentHistoryPage />} />
						{/* Legacy redirect: /student/history/:examId → /student/exam-review/:examId */}
						<Route
							path="/student/history/:examId"
							element={<HistoryExamRedirect />}
						/>
						<Route
							path="/student/exam-review/:examId"
