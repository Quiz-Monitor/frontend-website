...
import {
  Brain, LayoutDashboard, FileText, Database,
...
const NAV_ITEMS = [
  ...
  { id: 'exams',     label: 'My Exams',         icon: FileText,        path: '/instructor/my-exams' },
  { id: 'results',   label: 'Results Database',  icon: Database,        path: '/instructor/results-database' },
];
